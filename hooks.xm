...
%ctor {
    ...
    CFNotificationCenterAddObserver(CFNotificationCenterGetDarwinNotifyCenter(), NULL, (CFNotificationCallback)openApp, (CFStringRef)OpenAppFromJelly, NULL, (CFNotificationSuspensionBehavior) kNilOptions);
    CFNotificationCenterAddObserver(CFNotificationCenterGetDarwinNotifyCenter(), NULL, (CFNotificationCallback)hideCSQuickactions, (CFStringRef)hideCSQuickactionsFromJelly, NULL, (CFNotificationSuspensionBehavior) kNilOptions);
    CFNotificationCenterAddObserver(CFNotificationCenterGetDarwinNotifyCenter(), NULL, (CFNotificationCallback)showCSQuickactions, (CFStringRef)showCSQuickactionsFromJelly, NULL, (CFNotificationSuspensionBehavior) kNilOptions);
}
